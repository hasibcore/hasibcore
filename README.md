...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Hasibul%20Hasan-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/hasibul-hasan-dev)
[![Facebook](https://img.shields.io/badge/Facebook-hasibul.hasan.dev-1877F2?style=for-the-badge&logo=facebook&logoColor=white)](https://facebook.com/hasibul.hasan.dev)
[![Instagram](https://img.shields.io/badge/Instagram-hasibul.hasan.dev-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://instagram.com/hasibul.hasan.dev)
...
class HasibulHasan:
    ...
    education   = "B.Sc. in Computer Science & Technology @ AUST"
    location    = "Bangladesh 🇧🇩"
    languages   = ["C++", "Java", "Python", "Dart", "JavaScript", "TypeScript"]
    frameworks  = ["Flutter", "OpenCV", "Next.js", "React", "Node.js", "Tailwind CSS"]
    ...
    building    = [
        "🎨 AirCanvas (Touchless Vision Whiteboard)",
        "💬 LinkSphere (Offline P2P Mobile Chat)",
        "🌙 Godhuli.me (Ed-Tech Platform)",
        "🎮 Last Light of Hope (2D C++ Engine)"
    ]
...
### 🎨 AirCanvas
> Touchless Digital Whiteboard & Gesture Workspace

- 🖐️ Real-time webcam hand gesture tracking
- 🎨 OpenCV & Computer Vision rendering core
- 🖌️ Touchless brush, color picker & air eraser
- 📱 Cross-platform desktop & mobile integration

<br>

[![View Repo](https://img.shields.io/badge/🎨_View-AirCanvas-00F7FF?style=for-the-badge&logo=github&logoColor=black)](https://github.com/hasibcore/AirCanvas)

</td>
<td width="50%" valign="top">

### 💬 LinkSphere
> High-Performance Offline P2P Chat App

- 📡 Local Wi-Fi & P2P mesh network communication
- 🔒 Secure offline messaging & direct file sharing
- ⚡ Zero internet dependency & fast peer discovery
- 📱 Modern Flutter UI with real-time sync

<br>

[![View Repo](https://img.shields.io/badge/💬_View-LinkSphere-0A66C2?style=for-the-badge&logo=github&logoColor=white)](https://github.com/hasibcore/LinkSphere)
...
- 📚 SSC · HSC · Class 5–12 full curriculum
- 📝 Practice tests, quizzes & mock exams
- 🎥 Interactive video lessons & progress tracking
- 🌙 Beautiful full dark mode & ultra responsive

<br>

[![Visit Godhuli](https://img.shields.io/badge/🌐_Visit-Godhuli.me-8A2BE2?style=for-the-badge&logo=vercel&logoColor=white)](https://godhuli.me)
...
- 🕹️ Custom C++ core game engine
- 🖼️ iGraphics rendering system & maze mechanics
- 👻 Atmospheric horror storytelling & dynamic audio
- 💀 Multiple endings, puzzle challenges & secrets

<br>

[![View Repo](https://img.shields.io/badge/🎮_View-Repository-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/hasibcore/Last-Light-of-Hope)
...
- 💬 Building **[LinkSphere](https://github.com/hasibcore/LinkSphere)** — Offline P2P chat & file sharing app
- 🔭 Developing **[Godhuli.me](https://godhuli.me)** — Ed-Tech platform for Bangladesh
- 🎮 Maintaining **[Last Light of Hope](https://github.com/hasibcore/Last-Light-of-Hope)** — 2D horror C++ game
- 📚 Active competitive programmer on **Codeforces**, **AtCoder** & **LeetCode**
- 💬 Ask me about **C++**, **OpenCV**, **Flutter**, or **Algorithms**
...
[![GitHub followers](https://img.shields.io/github/followers/hasibcore?style=for-the-badge&color=A020F0&label=FOLLOWERS&logo=github)](https://github.com/hasibcore)
[![GitHub stars](https://img.shields.io/github/stars/hasibcore?style=for-the-badge&color=FFD93D&label=STARS&logo=github)](https://github.com/hasibcore?tab=stars)
...
**⭐ Thanks for visiting! Don't forget to star some repos ⭐**

<br>

![Footer](https://capsule-render.vercel.app/api?type=waving&height=120&color=0:00F5FF,100:A020F0&section=footer)
